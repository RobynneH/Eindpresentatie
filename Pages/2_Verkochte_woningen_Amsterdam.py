...
# fig.add_trace(go.Box(y = FS_bungalow["price_sold"], name = "Verkochte prijs per bungalow"))
# fig.add_trace(go.Box(y = FS_landhuis["price_sold"], name = "Verkochte prijs per landhuis"))
# fig.add_trace(go.Box(y = FS_boerderij["price_sold"], name = "Verkochte prijs per boerderij"))
# fig.add_trace(go.Box(y = FS_bouw["price_sold"], name = "Verkochte prijs per bouw"))
...
# # Maak de volgorde voor de grafiek van meest verkochte huis per wijk, naar minst verkochte huizen per wijk
# Funda_overeen["neighborhood_name"].value_counts().sort_values(ascending = False).index.tolist()
